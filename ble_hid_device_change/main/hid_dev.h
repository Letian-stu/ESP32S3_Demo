...
#define MY_CONTROL_GO_STOP        (uint8_t)(1 << 0)
#define MY_CONTROL_LIGHT_UP       (uint8_t)(1 << 1)
#define MY_CONTROL_LIGHT_DOWN     (uint8_t)(1 << 2)
#define MY_CONTROL_MUSIC_NEXT     (uint8_t)(1 << 3)
#define MY_CONTROL_MUSIC_PRV      (uint8_t)(1 << 4)
#define MY_CONTROL_VAL_UP         (uint8_t)(1 << 5)
#define MY_CONTROL_VAL_DOWN       (uint8_t)(1 << 6)
#define NULL_MASK                 (uint8_t)(1 << 7)
