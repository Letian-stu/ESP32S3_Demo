...
#define HID_RPT_ID_CONTROL_IN    5  // my control input report ID
#endif
...
enum {
    ...
    HIDD_LE_IDX_REPORT_CONTROL_IN_CHAR,
    HIDD_LE_IDX_REPORT_CONTROL_IN_VAL,
    HIDD_LE_IDX_REPORT_CONTROL_IN_CCC,
    HIDD_LE_IDX_REPORT_CONTROL_IN_REP_REF,
#endif
